...
SELECT SUM(departments.budget) AS sum_of_budgets
FROM departments;

SELECT departments.code, COUNT(*) AS count_of_employees
FROM departments
GROUP BY departments.code;

SELECT departments.code, COUNT(*) AS count_of_employees FROM departments
GROUP BY departments.code
HAVING COUNT(*) > 2;
...
SELECT departments.code, budget FROM departments where budget > 60000
...
WHERE department = (SELECT code FROM departments WHERE departments.name = 'IT');
